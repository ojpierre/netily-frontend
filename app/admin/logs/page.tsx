...
type ActorFilter = "all" | "admin" | "staff" | "system" | "user"

type AuditRow = AuditLog & {
  user_email?: string
  user_full_name?: string | null
  user_role?: string | null
  actor_type?: "admin" | "staff" | "superadmin" | "system" | "user"
...
export default function LogsPage() {
  ...
  const exportRows = () => {
    ...
    link.href = url
    link.download = `netily-audit-logs.csv`
    link.click()
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="grid gap-4 pt-6 md:grid-cols-2 xl:grid-cols-[1fr_160px_160px_160px_160px_auto]">
          ...
          <div>
            ...
            <Select value={actorFilter} onValueChange={(value) => setActorFilter(value as ActorFilter)}>
              <SelectTrigger className="mt-1">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="all">All actors</SelectItem>
                <SelectItem value="admin">Tenant admins</SelectItem>
