...
function AppearanceTab() {
  ...
  const colorOptions: { value: ColorTheme; label: string; accent: string; ring: string; bg: string; dark: string; swatch: string; activeText: string }[] = [
    ...
    },
    {
      ...
      bg: "bg-yellow-50",
      dark: "dark:bg-neutral-950",
      swatch: "bg-linear-to-br from-yellow-300 via-white to-neutral-950",
    ...
    },
    {
      ...
      ring: "ring-neutral-950",
      bg: "bg-neutral-50",
      dark: "dark:bg-neutral-950",
      swatch: "bg-linear-to-br from-white via-neutral-300 to-neutral-950",
      activeText: "text-neutral-950 dark:text-white",
    },
    {
      value: "cyber-orchid",
      label: "Cyber Orchid",
      ...
      swatch: "bg-linear-to-br from-cyan-400 via-fuchsia-500 to-violet-950",
      activeText: "text-cyan-700 dark:text-cyan-300",
    },
    {
