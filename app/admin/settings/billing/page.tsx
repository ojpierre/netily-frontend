...
import {
  Zap, Check, Users, Wifi, Shield, Clock, Download, Receipt, AlertTriangle, Loader2, ArrowRight
} from "lucide-react"
...
export default function BillingPage() {
    ...
    const loadBillingData = async () => {
      ...
      try {
        const [plansData, subData, usageData, invoicesData] = await Promise.all([
          ...
          // Filter for invoices generated by the platform (Netily Starters bills)
  ...
  // Maps the API NetilyPlan to the UI display format
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="current" className="space-y-6">
        ...
        {/* INVOICES TAB - No estimated data, only official objects */}
