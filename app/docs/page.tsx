  ...
  return (
    <div className="flex h-full flex-col overflow-hidden bg-white dark:bg-slate-950">
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4">
        ...
        {loading && (
          <div className="inline-flex items-center gap-2 rounded-2xl bg-slate-100 px-3.5 py-2.5 text-sm text-slate-500 dark:bg-slate-900">
          ...
          <div className="mx-auto max-w-3xl px-6 py-10 lg:px-10 lg:py-16">
            {activePage ? (
              ...
              >
                ...
                {/* Title & Actions */}
                <div className="mb-10 flex flex-col items-start justify-between gap-4 border-b border-slate-100 pb-6 dark:border-slate-800 sm:flex-row sm:items-center">
