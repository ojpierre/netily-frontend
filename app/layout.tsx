...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "B2B SaaS affiliate program for telecom",
    "WISP referral program",
    "MikroTik consultant referral program",
    "ISP billing software partner program",
    // — Location-specific —
    ...
    "South Africa ISP billing software",
    ...
    "M-Pesa ISP billing Tanzania",
    "Tigo Pesa ISP billing Tanzania",
    "East Africa ISP SaaS",
    "Africa ISP billing SaaS",
    "UK ISP billing software",
    "UK altnet billing software",
    "USA WISP billing software",
    "United States ISP billing software",
    "Australia WISP billing software",
    "New Zealand ISP billing software",
    "Direct Debit ISP billing UK",
    "ACH ISP billing USA",
    "BECS ISP billing Australia",
    "Windcave ISP billing New Zealand",
...
export default function RootLayout({
  ...
  // Resolve the API origin server-side for preconnect
  // In production, this will be the actual API domain
  ...
  return (
    <html lang="en" className={fontVariables} suppressHydrationWarning>
      <head>
        ...
        {/* ── FIX 6: Preconnect to API domain ── */}
        {/* Cuts DNS + TLS handshake off the critical path for hotspot devices */}
