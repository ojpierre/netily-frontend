...
const accountLinks = [
  { href: "/account/profile", label: "Profile & Organization", icon: User },
  { href: "/account/orders", label: "Orders & Invoices", icon: Package },
  { href: "/account/addresses", label: "Sites & Delivery", icon: MapPin },
