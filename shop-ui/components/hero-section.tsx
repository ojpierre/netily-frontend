...
const slides = [
  {
    ...
    image: "/shop-assets/netily_hero_bg.jpg",
    primaryCta: { label: "Explore Routers", href: "/shop/catalog?cat=Routers+%26+Gateways" },
    secondaryCta: { label: "Our Story", href: "/shop/heritage" },
  },
  {
    id: "fiber",
    ...
    primaryCta: { label: "Fiber & FTTH", href: "/shop/catalog?cat=Fiber+Optics+%26+FTTH" },
    secondaryCta: { label: "View Catalog", href: "/shop/catalog" },
  },
  {
    id: "cabling",
    ...
    primaryCta: { label: "Shop Cabling", href: "/shop/catalog?cat=Structured+Cabling" },
    secondaryCta: { label: "View All Gear", href: "/shop/catalog" },
  },
  {
    id: "workstations",
    ...
    primaryCta: { label: "Shop Devices", href: "/shop/catalog" },
    secondaryCta: { label: "Our Heritage", href: "/shop/heritage" },
  },
]
