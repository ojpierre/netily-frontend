...
export function PremiumFooter() {
  const footerLinks = {
    shop: [
      ...
      { label: "Fiber Optics & OLT", href: "/shop/catalog?cat=Fiber+Optics+%26+FTTH" },
      { label: "Structured Cabling", href: "/shop/catalog?cat=Structured+Cabling" },
      { label: "Workstations & Tech", href: "/shop/catalog?cat=Laptops" },
    ],
    about: [
      { label: "Our Story", href: "/shop/heritage" },
      { label: "B2B Proforma Quotes", href: "/checkout" },
      { label: "Authorized Partner", href: "/shop/heritage" },
      { label: "Admin Console", href: "/shop/admin" },
    ],
    support: [
      { label: "Contact Engineering", href: "/shop/heritage" },
      { label: "Shipping & Tower Dispatch", href: "/shop/account/addresses" },
      { label: "Order Tracking", href: "/shop/account/orders" },
      { label: "Account Settings", href: "/shop/account/profile" },
    ],
  }
