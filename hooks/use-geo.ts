...
const GEO_TABLE: Record<string, GeoInfo> = {
  ...
  GB: {
    ...
    currencySymbol: "£",
    rateFromKES: 0.0058,
    paymentCopy: "Direct Debit, Stripe & cards",
    flag: "UK",
  },
  US: {
    countryCode: "US",
  ...
  NZ: {
    ...
    currencySymbol: "NZ$",
    rateFromKES: 0.013,
    paymentCopy: "Stripe, Windcave & bank transfer",
    flag: "NZ",
  },
}
